...
3. For this test just keep it simple, there's no need to use a CSS Pre-processor or a complex JS Framework. If you need a CSS Framework to work, use [Bootstrap 4 or 5](https://getbootstrap.com/). We use it as Agency.
